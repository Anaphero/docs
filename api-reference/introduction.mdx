...
<Accordion icon='code' title='Sending your first request'>
    The base URL for the API is: ```https://api.clarionhealth.ai/v1```. You can test out your connection by sending the following request:

    ```GET https://api.clarionhealth.ai/v1/health```
  ...
  <Accordion icon='key' title='Get your API key'>
    ...
    it, please reach out to support@clarionhealth.ai
...
`GET https://api.clarionhealth.ai/v1/call`
